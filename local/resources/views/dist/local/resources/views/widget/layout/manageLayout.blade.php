@section("fis_resource")@require('widget/layout/manageLayout.blade.php')@require('dist/local/resources/views/widget/layout/manageLayout.blade.php')@show<!DOCTYPE html>
<html>
<head>
