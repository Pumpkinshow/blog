@extends('dist/local/resources/views/widget/layout/front.blade.php')
...
@section("fis_resource")@parent @require('page/index.blade.php')@stop@section("fis_resource")@parent @require('dist/local/resources/views/index.blade.php')@stop