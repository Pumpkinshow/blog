...
@section("fis_resource")@parent @require('page/manage/login.blade.php')@stop@section("fis_resource")@parent @require('dist/local/resources/views/manage/login.blade.php')@stop