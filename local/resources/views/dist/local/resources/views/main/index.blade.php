...
@section("fis_resource")@parent @require('page/main/index.blade.php')@stop@section("fis_resource")@parent @require('dist/local/resources/views/main/index.blade.php')@stop